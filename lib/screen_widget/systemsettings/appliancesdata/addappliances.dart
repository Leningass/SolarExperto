...
class AddAppliances extends StatefulWidget {
  const AddAppliances({Key? key, required this.categoryname}) : super(key: key);
                    ...
                    ElevatedButton.icon(
                      ...
                      onPressed: () async {
                        if (applianceform.currentState!.validate()) {
                          ...
                          await uploadImage('Appliances/appliances#$id', file!)
                              .then((value) => setState(() {
                                    if (value != null) {
                                      ImageUrl = value;
                                    } else {
                          ...
                          if (ImageUrl != null) {
                            await DatabaseService().updateappliances(
                                'appliances#$id',
                                name.text.toString(),
